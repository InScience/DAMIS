...
${OBJECTDIR}/DMA.o: DMA.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/DMA.o DMA.cpp
...
${OBJECTDIR}/Projection.o: Projection.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Projection.o Projection.cpp
...
${OBJECTDIR}/SDS.o: SDS.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/SDS.o SDS.cpp
...
${OBJECTDIR}/SOMMDS.o: SOMMDS.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/SOMMDS.o SOMMDS.cpp
...
${TESTDIR}/tests/arffTest.o: tests/arffTest.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -I. `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${TESTDIR}/tests/arffTest.o tests/arffTest.cpp
...
${OBJECTDIR}/DMA_nomain.o: ${OBJECTDIR}/DMA.o DMA.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/DMA_nomain.o DMA.cpp;\
	else  \
...
${OBJECTDIR}/Projection_nomain.o: ${OBJECTDIR}/Projection.o Projection.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/Projection_nomain.o Projection.cpp;\
	else  \
...
${OBJECTDIR}/SDS_nomain.o: ${OBJECTDIR}/SDS.o SDS.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/SDS_nomain.o SDS.cpp;\
	else  \
...
${OBJECTDIR}/SOMMDS_nomain.o: ${OBJECTDIR}/SOMMDS.o SOMMDS.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/SOMMDS_nomain.o SOMMDS.cpp;\
	else  \
