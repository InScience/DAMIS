...
LDLIBSOPTIONS=alglib/libalglib.so `cppunit-config --libs`  

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${TESTDIR}/TestFiles/f5

${TESTDIR}/TestFiles/f5: alglib/libalglib.so
...
${OBJECTDIR}/AdditionalMethods.o: AdditionalMethods.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I. -I. `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${OBJECTDIR}/AdditionalMethods.o AdditionalMethods.cpp

${OBJECTDIR}/DMA.o: DMA.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I. -I. `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${OBJECTDIR}/DMA.o DMA.cpp

${OBJECTDIR}/DataObject.o: DataObject.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I. -I. `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${OBJECTDIR}/DataObject.o DataObject.cpp

${OBJECTDIR}/DimReductionMethod.o: DimReductionMethod.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I. -I. `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${OBJECTDIR}/DimReductionMethod.o DimReductionMethod.cpp

${OBJECTDIR}/DistanceMetrics.o: DistanceMetrics.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I. -I. `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${OBJECTDIR}/DistanceMetrics.o DistanceMetrics.cpp

${OBJECTDIR}/Feature.o: Feature.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I. -I. `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${OBJECTDIR}/Feature.o Feature.cpp

${OBJECTDIR}/HPCMethod.o: HPCMethod.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I. -I. `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${OBJECTDIR}/HPCMethod.o HPCMethod.cpp

${OBJECTDIR}/MDS.o: MDS.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I. -I. `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${OBJECTDIR}/MDS.o MDS.cpp

${OBJECTDIR}/ObjectMatrix.o: ObjectMatrix.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I. -I. `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${OBJECTDIR}/ObjectMatrix.o ObjectMatrix.cpp

${OBJECTDIR}/PCA.o: PCA.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I. -I. `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${OBJECTDIR}/PCA.o PCA.cpp

${OBJECTDIR}/Projection.o: Projection.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I. -I. `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${OBJECTDIR}/Projection.o Projection.cpp

${OBJECTDIR}/SAMANN.o: SAMANN.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I. -I. `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${OBJECTDIR}/SAMANN.o SAMANN.cpp

${OBJECTDIR}/SDS.o: SDS.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I. -I. `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${OBJECTDIR}/SDS.o SDS.cpp

${OBJECTDIR}/SMACOF.o: SMACOF.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I. -I. `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${OBJECTDIR}/SMACOF.o SMACOF.cpp

${OBJECTDIR}/SMACOFZEIDEL.o: SMACOFZEIDEL.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I. -I. `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${OBJECTDIR}/SMACOFZEIDEL.o SMACOFZEIDEL.cpp

${OBJECTDIR}/SOM.o: SOM.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I. -I. `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${OBJECTDIR}/SOM.o SOM.cpp

${OBJECTDIR}/SOMMDS.o: SOMMDS.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I. -I. `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${OBJECTDIR}/SOMMDS.o SOMMDS.cpp

${OBJECTDIR}/ShufleObjects.o: ShufleObjects.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I. -I. `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${OBJECTDIR}/ShufleObjects.o ShufleObjects.cpp

${OBJECTDIR}/Statistics.o: Statistics.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I. -I. `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${OBJECTDIR}/Statistics.o Statistics.cpp

${OBJECTDIR}/arff.o: arff.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I. -I. `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${OBJECTDIR}/arff.o arff.cpp

${OBJECTDIR}/main.o: main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I. -I. `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${OBJECTDIR}/main.o main.cpp
...
${TESTDIR}/tests/arffTest.o: tests/arffTest.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I. -I. -I. `cppunit-config --cflags`   `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${TESTDIR}/tests/arffTest.o tests/arffTest.cpp


${TESTDIR}/tests/gutmanTest.o: tests/gutmanTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I. -I. -I. `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${TESTDIR}/tests/gutmanTest.o tests/gutmanTest.cpp


${TESTDIR}/tests/methodsTest.o: tests/methodsTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I. -I. -I. `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${TESTDIR}/tests/methodsTest.o tests/methodsTest.cpp


${TESTDIR}/tests/pcatest.o: tests/pcatest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I. -I. -I. `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${TESTDIR}/tests/pcatest.o tests/pcatest.cpp


${TESTDIR}/tests/smacofTest.o: tests/smacofTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I. -I. -I. `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${TESTDIR}/tests/smacofTest.o tests/smacofTest.cpp


${TESTDIR}/tests/smacofZeidelTest.o: tests/smacofZeidelTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I. -I. -I. `cppunit-config --cflags`   `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${TESTDIR}/tests/smacofZeidelTest.o tests/smacofZeidelTest.cpp
...
${OBJECTDIR}/AdditionalMethods_nomain.o: ${OBJECTDIR}/AdditionalMethods.o AdditionalMethods.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -I. -I. -I. `cppunit-config --cflags` -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/AdditionalMethods_nomain.o AdditionalMethods.cpp;\
	else  \
...
${OBJECTDIR}/DMA_nomain.o: ${OBJECTDIR}/DMA.o DMA.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -I. -I. -I. `cppunit-config --cflags` -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/DMA_nomain.o DMA.cpp;\
	else  \
...
${OBJECTDIR}/DataObject_nomain.o: ${OBJECTDIR}/DataObject.o DataObject.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -I. -I. -I. `cppunit-config --cflags` -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/DataObject_nomain.o DataObject.cpp;\
	else  \
...
${OBJECTDIR}/DimReductionMethod_nomain.o: ${OBJECTDIR}/DimReductionMethod.o DimReductionMethod.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -I. -I. -I. `cppunit-config --cflags` -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/DimReductionMethod_nomain.o DimReductionMethod.cpp;\
	else  \
...
${OBJECTDIR}/DistanceMetrics_nomain.o: ${OBJECTDIR}/DistanceMetrics.o DistanceMetrics.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -I. -I. -I. `cppunit-config --cflags` -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/DistanceMetrics_nomain.o DistanceMetrics.cpp;\
	else  \
...
${OBJECTDIR}/Feature_nomain.o: ${OBJECTDIR}/Feature.o Feature.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -I. -I. -I. `cppunit-config --cflags` -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/Feature_nomain.o Feature.cpp;\
	else  \
...
${OBJECTDIR}/HPCMethod_nomain.o: ${OBJECTDIR}/HPCMethod.o HPCMethod.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -I. -I. -I. `cppunit-config --cflags` -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/HPCMethod_nomain.o HPCMethod.cpp;\
	else  \
...
${OBJECTDIR}/MDS_nomain.o: ${OBJECTDIR}/MDS.o MDS.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -I. -I. -I. `cppunit-config --cflags` -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/MDS_nomain.o MDS.cpp;\
	else  \
...
${OBJECTDIR}/ObjectMatrix_nomain.o: ${OBJECTDIR}/ObjectMatrix.o ObjectMatrix.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -I. -I. -I. `cppunit-config --cflags` -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/ObjectMatrix_nomain.o ObjectMatrix.cpp;\
	else  \
...
${OBJECTDIR}/PCA_nomain.o: ${OBJECTDIR}/PCA.o PCA.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -I. -I. -I. `cppunit-config --cflags` -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/PCA_nomain.o PCA.cpp;\
	else  \
...
${OBJECTDIR}/Projection_nomain.o: ${OBJECTDIR}/Projection.o Projection.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -I. -I. -I. `cppunit-config --cflags` -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/Projection_nomain.o Projection.cpp;\
	else  \
...
${OBJECTDIR}/SAMANN_nomain.o: ${OBJECTDIR}/SAMANN.o SAMANN.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -I. -I. -I. `cppunit-config --cflags` -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/SAMANN_nomain.o SAMANN.cpp;\
	else  \
...
${OBJECTDIR}/SDS_nomain.o: ${OBJECTDIR}/SDS.o SDS.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -I. -I. -I. `cppunit-config --cflags` -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/SDS_nomain.o SDS.cpp;\
	else  \
...
${OBJECTDIR}/SMACOF_nomain.o: ${OBJECTDIR}/SMACOF.o SMACOF.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -I. -I. -I. `cppunit-config --cflags` -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/SMACOF_nomain.o SMACOF.cpp;\
	else  \
...
${OBJECTDIR}/SMACOFZEIDEL_nomain.o: ${OBJECTDIR}/SMACOFZEIDEL.o SMACOFZEIDEL.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -I. -I. -I. `cppunit-config --cflags` -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/SMACOFZEIDEL_nomain.o SMACOFZEIDEL.cpp;\
	else  \
...
${OBJECTDIR}/SOM_nomain.o: ${OBJECTDIR}/SOM.o SOM.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -I. -I. -I. `cppunit-config --cflags` -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/SOM_nomain.o SOM.cpp;\
	else  \
...
${OBJECTDIR}/SOMMDS_nomain.o: ${OBJECTDIR}/SOMMDS.o SOMMDS.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -I. -I. -I. `cppunit-config --cflags` -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/SOMMDS_nomain.o SOMMDS.cpp;\
	else  \
...
${OBJECTDIR}/ShufleObjects_nomain.o: ${OBJECTDIR}/ShufleObjects.o ShufleObjects.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -I. -I. -I. `cppunit-config --cflags` -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/ShufleObjects_nomain.o ShufleObjects.cpp;\
	else  \
...
${OBJECTDIR}/Statistics_nomain.o: ${OBJECTDIR}/Statistics.o Statistics.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -I. -I. -I. `cppunit-config --cflags` -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/Statistics_nomain.o Statistics.cpp;\
	else  \
...
${OBJECTDIR}/arff_nomain.o: ${OBJECTDIR}/arff.o arff.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -I. -I. -I. `cppunit-config --cflags` -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/arff_nomain.o arff.cpp;\
	else  \
...
${OBJECTDIR}/main_nomain.o: ${OBJECTDIR}/main.o main.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -I. -I. -I. `cppunit-config --cflags` -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/main_nomain.o main.cpp;\
	else  \
