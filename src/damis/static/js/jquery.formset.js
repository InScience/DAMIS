...
;(function($) {
    ...
    $.fn.formset.defaults = {
        ...
        addText: '<button class="btn"><i class="icon-plus"></i>' + gettext("another") + '</button>',  // Text for the add link
        deleteText: '<button class="btn"><i class="icon-remove"></i>' + gettext("remove") + '</button>',  // Text for the delete link
