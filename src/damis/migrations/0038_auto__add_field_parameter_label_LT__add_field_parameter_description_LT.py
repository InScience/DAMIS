...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Parameter.label_LT'
        db.add_column(u'damis_parameter', 'label_LT',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Parameter.description_LT'
        db.add_column(u'damis_parameter', 'description_LT',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Component.label_lt'
        db.add_column(u'damis_component', 'label_lt',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Component.description_lt'
        db.add_column(u'damis_component', 'description_lt',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Parameter.label_LT'
        db.delete_column(u'damis_parameter', 'label_LT')

        # Deleting field 'Parameter.description_LT'
        db.delete_column(u'damis_parameter', 'description_LT')

        # Deleting field 'Component.label_lt'
        db.delete_column(u'damis_component', 'label_lt')

        # Deleting field 'Component.description_lt'
        db.delete_column(u'damis_component', 'description_lt')
