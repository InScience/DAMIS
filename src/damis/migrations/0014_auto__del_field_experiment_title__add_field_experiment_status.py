...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'damis_experiment', 'status',
                      self.gf('django.db.models.fields.CharField')(default='CREATED', max_length=50, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'damis_experiment', 'status')
