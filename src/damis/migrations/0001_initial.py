...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'damis_dataset', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('license', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['damis.DatasetLicense'])),
            ('file', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('file_format', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['damis.FileFormat'])),
            ('description', self.gf('django.db.models.fields.TextField')()),
        ...
        db.send_create_signal(u'damis', ['Dataset'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'damis_dataset')
