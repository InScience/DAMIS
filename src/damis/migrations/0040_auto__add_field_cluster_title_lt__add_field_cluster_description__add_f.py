...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cluster.title_lt'
        db.add_column(u'damis_cluster', 'title_lt',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'Cluster.description'
        db.add_column(u'damis_cluster', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Cluster.description_lt'
        db.add_column(u'damis_cluster', 'description_lt',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cluster.title_lt'
        db.delete_column(u'damis_cluster', 'title_lt')

        # Deleting field 'Cluster.description'
        db.delete_column(u'damis_cluster', 'description')

        # Deleting field 'Cluster.description_lt'
        db.delete_column(u'damis_cluster', 'description_lt')
