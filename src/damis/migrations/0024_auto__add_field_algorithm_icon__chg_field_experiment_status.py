...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Algorithm.icon'
        db.add_column(u'damis_algorithm', 'icon',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Experiment.status'
        db.alter_column(u'damis_experiment', 'status', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):
        # Deleting field 'Algorithm.icon'
        db.delete_column(u'damis_algorithm', 'icon')


        # Changing field 'Experiment.status'
        db.alter_column(u'damis_experiment', 'status', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
