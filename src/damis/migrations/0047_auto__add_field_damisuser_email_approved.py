...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DamisUser.email_approved'
        db.add_column(u'damis_damisuser', 'email_approved',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DamisUser.email_approved'
        db.delete_column(u'damis_damisuser', 'email_approved')
