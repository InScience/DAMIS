...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Component.executable_file'
        db.delete_column(u'damis_component', 'executable_file')

        # Adding field 'Component.label'
        db.add_column(u'damis_component', 'label',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Component.executable_file'
        db.add_column(u'damis_component', 'executable_file',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Component.label'
        db.delete_column(u'damis_component', 'label')
