...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Component.file'
        db.delete_column(u'damis_component', 'file')

        # Adding field 'Component.wsdl'
        db.add_column(u'damis_component', 'wsdl',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Component.function'
        db.add_column(u'damis_component', 'function',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Component.file'
        raise RuntimeError("Cannot reverse this migration. 'Component.file' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Component.file'
        db.add_column(u'damis_component', 'file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100),
                      keep_default=False)

        # Deleting field 'Component.wsdl'
        db.delete_column(u'damis_component', 'wsdl')

        # Deleting field 'Component.function'
        db.delete_column(u'damis_component', 'function')
