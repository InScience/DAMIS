...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Experiment.processors'
        db.delete_column(u'damis_experiment', 'processors')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Experiment.processors'
        raise RuntimeError("Cannot reverse this migration. 'Experiment.processors' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Experiment.processors'
        db.add_column(u'damis_experiment', 'processors',
