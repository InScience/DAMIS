...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Dataset.is_from_midas'
        db.add_column(u'damis_dataset', 'is_from_midas',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Dataset.is_from_midas'
        db.delete_column(u'damis_dataset', 'is_from_midas')
