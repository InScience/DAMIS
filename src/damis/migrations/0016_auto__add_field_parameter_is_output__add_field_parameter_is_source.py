...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Parameter.is_source'
        db.add_column(u'damis_parameter', 'is_source',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Parameter.is_source'
        db.delete_column(u'damis_parameter', 'is_source')
