...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Dataset.license'
        db.delete_column(u'damis_dataset', 'license_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Dataset.license'
        db.add_column(u'damis_dataset', 'license',
    ...
    models = {
        ...
        u'damis.task': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_workflow_start': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        }
    }
