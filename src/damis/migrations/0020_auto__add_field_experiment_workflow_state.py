...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Experiment.workflow_state'
        db.add_column(u'damis_experiment', 'workflow_state',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Experiment.workflow_state'
        db.delete_column(u'damis_experiment', 'workflow_state')
