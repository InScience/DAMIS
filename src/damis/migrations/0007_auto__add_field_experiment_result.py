...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Experiment.result'
        db.add_column(u'damis_experiment', 'result',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='result_for_experiment', to=orm['damis.Task']),
                      keep_default=False)
    ...
    models = {
        ...
        u'damis.experiment': {
            ...
            'result': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'result_for_experiment'", 'to': u"orm['damis.Task']"}),
