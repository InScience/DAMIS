...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.dataset'
        db.add_column(u'damis_task', 'dataset',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['damis.Dataset'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Experiment.result'
        db.delete_column(u'damis_experiment', 'result_id')


    def backwards(self, orm):
        # Deleting field 'Task.dataset'
        db.delete_column(u'damis_task', 'dataset_id')


        # User chose to not deal with backwards NULL issues for 'Experiment.result'
        raise RuntimeError("Cannot reverse this migration. 'Experiment.result' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Experiment.result'
        db.add_column(u'damis_experiment', 'result',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='result_for_experiment', to=orm['damis.Task']),
                      keep_default=False)
