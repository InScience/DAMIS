...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Algorithm.description'
        db.add_column(u'damis_algorithm', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Parameter.label'
        db.add_column(u'damis_parameter', 'label',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Parameter.description'
        db.add_column(u'damis_parameter', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Algorithm.description'
        db.delete_column(u'damis_algorithm', 'description')

        # Deleting field 'Parameter.label'
        db.delete_column(u'damis_parameter', 'label')

        # Deleting field 'Parameter.description'
        db.delete_column(u'damis_parameter', 'description')
