...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'damis_workflowtask', 'status',
                      self.gf('django.db.models.fields.CharField')(default='SAVED', max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WorkflowTask.status'
        db.delete_column(u'damis_workflowtask', 'status')
