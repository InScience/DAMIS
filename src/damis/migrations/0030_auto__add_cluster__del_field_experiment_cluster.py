...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'damis_cluster', (
            ...
            ('workload_url', self.gf('django.db.models.fields.URLField')(max_length=255, null=True)),
        ))
        db.send_create_signal(u'damis', ['Cluster'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'damis_cluster')
