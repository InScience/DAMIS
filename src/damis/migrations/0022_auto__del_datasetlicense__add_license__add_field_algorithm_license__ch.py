...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'DatasetLicense'
        db.delete_table(u'damis_datasetlicense')

        # Adding model 'License'
        db.create_table(u'damis_license', (
        ...
        db.send_create_signal(u'damis', ['License'])

        # Adding field 'Algorithm.license'
        db.add_column(u'damis_algorithm', 'license',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['damis.License'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'Dataset.license'
        db.alter_column(u'damis_dataset', 'license_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['damis.License'], null=True))

    def backwards(self, orm):
        # Adding model 'DatasetLicense'
        db.create_table(u'damis_datasetlicense', (
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
        ...
        db.send_create_signal(u'damis', ['DatasetLicense'])

        # Deleting model 'License'
        db.delete_table(u'damis_license')

        # Deleting field 'Algorithm.license'
        db.delete_column(u'damis_algorithm', 'license_id')


        # Changing field 'Dataset.license'
        db.alter_column(u'damis_dataset', 'license_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['damis.DatasetLicense'], null=True))
