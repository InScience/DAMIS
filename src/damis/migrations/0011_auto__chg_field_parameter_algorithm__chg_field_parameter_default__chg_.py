...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'damis_parameter', 'default', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Parameter.type'
        db.alter_column(u'damis_parameter', 'type', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Parameter.algorithm'
        raise RuntimeError("Cannot reverse this migration. 'Parameter.algorithm' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Parameter.algorithm'
        db.alter_column(u'damis_parameter', 'algorithm_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['damis.Algorithm']))

        # User chose to not deal with backwards NULL issues for 'Parameter.default'
        raise RuntimeError("Cannot reverse this migration. 'Parameter.default' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Parameter.default'
        db.alter_column(u'damis_parameter', 'default', self.gf('django.db.models.fields.CharField')(max_length=255))

        # User chose to not deal with backwards NULL issues for 'Parameter.type'
        raise RuntimeError("Cannot reverse this migration. 'Parameter.type' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Parameter.type'
        db.alter_column(u'damis_parameter', 'type', self.gf('django.db.models.fields.CharField')(max_length=255))
