...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Dataset.license'
        raise RuntimeError("Cannot reverse this migration. 'Dataset.license' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Dataset.license'
        db.alter_column(u'damis_dataset', 'license_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['damis.DatasetLicense']))
