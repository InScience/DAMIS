...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'damis_experiment', 'title',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)


        # Changing field 'Experiment.start'
        db.alter_column(u'damis_experiment', 'start', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Experiment.finish'
        db.alter_column(u'damis_experiment', 'finish', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Experiment.title'
        db.delete_column(u'damis_experiment', 'title')


        # Changing field 'Experiment.start'
        db.alter_column(u'damis_experiment', 'start', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True))

        # Changing field 'Experiment.finish'
        db.alter_column(u'damis_experiment', 'finish', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True))
