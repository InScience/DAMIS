...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DamisUser'
        db.create_table(u'damis_damisuser', (
        ...
        db.send_create_signal(u'damis', ['DamisUser'])

        # Adding M2M table for field groups on 'DamisUser'
        m2m_table_name = db.shorten_name(u'damis_damisuser_groups')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('damisuser', models.ForeignKey(orm[u'damis.damisuser'], null=False)),
            ('group', models.ForeignKey(orm[u'auth.group'], null=False))
        ))
        db.create_unique(m2m_table_name, ['damisuser_id', 'group_id'])

        # Adding M2M table for field user_permissions on 'DamisUser'
        m2m_table_name = db.shorten_name(u'damis_damisuser_user_permissions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('damisuser', models.ForeignKey(orm[u'damis.damisuser'], null=False)),
            ('permission', models.ForeignKey(orm[u'auth.permission'], null=False))
        ))
        db.create_unique(m2m_table_name, ['damisuser_id', 'permission_id'])


        # Changing field 'Component.user'
        db.alter_column(u'damis_component', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['damis.DamisUser'], null=True))

        # Changing field 'Dataset.user'
        db.alter_column(u'damis_dataset', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['damis.DamisUser'], null=True))

        # Changing field 'Experiment.user'
        db.alter_column(u'damis_experiment', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['damis.DamisUser']))

    def backwards(self, orm):
        # Deleting model 'DamisUser'
        db.delete_table(u'damis_damisuser')

        # Removing M2M table for field groups on 'DamisUser'
        db.delete_table(db.shorten_name(u'damis_damisuser_groups'))

        # Removing M2M table for field user_permissions on 'DamisUser'
        db.delete_table(db.shorten_name(u'damis_damisuser_user_permissions'))


        # Changing field 'Component.user'
        db.alter_column(u'damis_component', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

        # Changing field 'Dataset.user'
        db.alter_column(u'damis_dataset', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

        # Changing field 'Experiment.user'
        db.alter_column(u'damis_experiment', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))
