...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'damis_workflowtask', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('experiment', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tasks', null=True, to=orm['damis.Experiment'])),
            ('algorithm', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['damis.Component'])),
        ))
        db.send_create_signal(u'damis', ['WorkflowTask'])


        # Changing field 'ParameterValue.task'
        db.alter_column(u'damis_parametervalue', 'task_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['damis.WorkflowTask']))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'damis_workflowtask')


        # Changing field 'ParameterValue.task'
        db.alter_column(u'damis_parametervalue', 'task_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['damis.Task']))
