...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Parameter.connection_type'
        db.add_column(u'damis_parameter', 'connection_type',
                      self.gf('django.db.models.fields.CharField')(default='INPUT_VALUE', max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Parameter.connection_type'
        db.delete_column(u'damis_parameter', 'connection_type')
