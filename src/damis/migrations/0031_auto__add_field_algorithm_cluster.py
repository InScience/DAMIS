...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Algorithm.cluster'
        db.add_column(u'damis_algorithm', 'cluster',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='tasks', null=True, to=orm['damis.Cluster']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Algorithm.cluster'
        db.delete_column(u'damis_algorithm', 'cluster_id')
    ...
    models = {
        ...
        u'damis.algorithm': {
            ...
            'cluster': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'tasks'", 'null': 'True', 'to': u"orm['damis.Cluster']"}),
