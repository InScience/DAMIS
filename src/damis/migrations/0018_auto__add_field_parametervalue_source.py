...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'damis_parametervalue', 'source',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['damis.ParameterValue'], null=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'damis.parametervalue': {
            ...
            'source': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['damis.ParameterValue']", 'null': 'True'}),
        ...
        u'damis.task': {
            ...
            'dataset': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['damis.Dataset']", 'null': 'True'}),
